...
const translations: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "projects.view": "View project",
      ...
      "project.4.title": "Nomad",
        "project.4.category": "Desktop App",
      ...
      "project.5.title": "Nação BRB Fla",
        "project.5.category": "Desktop App",
        "project.5.description": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Excepteur sint occaecat cupidatat non proident, sunt in culpa.",
        "project.5.details": "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti.",
        "project.5.role": "Designer de Marca",
      "project.6.title": "Detran de Roraima",
        "project.6.category": "Desktop App",
        "project.6.description": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Excepteur sint occaecat cupidatat non proident, sunt in culpa.",
        "project.6.details": "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti.",
        "project.6.role": "Designer de Marca",
      "project.7.title": "Leo Madeiras",
        "project.7.category": "Desktop App",
        "project.7.description": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Excepteur sint occaecat cupidatat non proident, sunt in culpa.",
        "project.7.details": "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti.",
        "project.7.role": "Designer de Marca",
      "project.8.title": "Fight Go",
        "project.8.category": "Desktop App",
        "project.8.description": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Excepteur sint occaecat cupidatat non proident, sunt in culpa.",
        "project.8.details": "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti.",
        "project.8.role": "Designer de Marca",
      "project.9.title": "Linkfor",
        "project.9.category": "Desktop App",
        "project.9.description": "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Excepteur sint occaecat cupidatat non proident, sunt in culpa.",
        "project.9.details": "At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti.",
        "project.9.role": "Designer de Marca",
  ...
  pt: {
    ...
    "about.heading": "Sobre",
    "about.bg": "SOBRE",
    "about.intro": "Eu sou o Lucas, moro em Brasília - DF e sou fascinado por automobilismo e esportes que possuem adrenalina inserida. Acredito que desafios e novas experiências são o que tornam a jornada mais interessante.",
    "about.body": "No design, transformo esses desafios em soluções simples, intuitivas e funcionais, sempre guiado pela resolução de problemas reais e pela construção de produtos digitais mais claros, eficientes e úteis.",

    // Contact
    "contact.heading": "Vamos conversar?",
    "contact.body": "Se quiser trocar ideias, discutir projetos ou iniciar uma colaboração, fique à vontade para clicar abaixo e entrar em contato comigo.",
    "contact.copyright": "©2026 - Lucas Porta",
  },
};
